...
Most conferences in the field of computer systems hovered around 10% FAR while the entire field of AI averaged a little higer at
...
data.frame(Subfield = subfield_summary$subfield,
  ...
  knitr::kable(format = "latex",
               ...
               align = "lrrrr",
               linesep = "",
               caption = "Comparison of subfields by different gender metrics, ordered by FAR. Metrics include mean productivity (papers per author), ratio of men's productivity to women's, mean total coauthors (with repeats).") %>%
...
To test this hypothesis, we built a linear regression model using FAR as our outcome variable and all other metrics as predictors.
