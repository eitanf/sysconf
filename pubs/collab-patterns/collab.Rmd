...
Specifically, we collected extensive and accurate gender data to answer the following research questions:
  ...
  **RQ1**: Do women collaborate with fewer people than men?

  **RQ2**: Does collaboration amount vary by the gender of the collaborators?

  **RQ3**: Do women publish fewer single-author papers?
  
  **RQ4**: What is the relationship between the cost of the system investigated and gender and collaboration patterns?

  **RQ5**: TODO: question(s) from Whittington
...
RQ1: Mean collaborations per paper, and total no. of collaborators overall.
