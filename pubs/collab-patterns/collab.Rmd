...
This question could be addressed by two distinct measures: the mean number of coauthors per paper and the size of the total cohort for each author.
...
Interestingly, authorship norms vary significantly by field, if not by gender,  with computer systems averaging
...
Unfortunately, it cannot be neatly broken down by fields, because cohorts often include authors that span more than one field.
