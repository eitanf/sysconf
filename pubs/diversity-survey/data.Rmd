...
df %>%
    knitr::kable(format = "latex", longtable = F, booktabs = T, align = c('l', 'c', 'c', 'r', 'r', 'l', 'c', 'c', 'r', 'r'),
                 caption = "Conferences in our dataset with their start date, double-blind policy, number of accepted papers, and survey response rate by papers", escape = T) %>%
...
This study and the survey question were approved by the Reed College IRB (number 2018-S13). As an opt-in email survey, participants could choose to share their responses with us after they were informed of the questions and the purpose of the survey. All individual responses remain confidential, and are not shared as part of the code and the data accompanying this paper. The data shared in the supplementary material was collated and collected from publicly available sources on the Web.