...
of the "Yes" respondents also reported that they took advantage of the rebuttal option. The few who did not received higher overall acceptance score on average,
...
(`r report_t(t.test(nonrb$hindex, authors$hindex))`) and are mostly academics
...
(`r report_chi(chisq.test(table(survey$understanding, survey$length)))`) [@hames08:peer; @papagiannaki07:author]. Still, longer is not always better or necessary, as these short reviews still comprise
