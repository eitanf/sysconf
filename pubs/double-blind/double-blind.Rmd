...
- What is the relationship between PC h-index (mean/meadin) and authors' h-index? PC-author-ratio vs max_h?
...
## Findings so far: {-}
 ...
 - This reversal isn't changed whether we drop the NA H-index, flatten them, or linearly impute them from # papers or S2npubs (at least for median).
