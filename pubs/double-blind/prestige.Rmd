...
* Double-blind (DB) reviewing has been suggested as a way to reduce bias in the review process, including "prestige bias".
* Various studies found evidence for and against prestige bias in single-blind (SB) reviewing
...
We can also use a third source of paper counts that ignores the past altogether, using only up-to-date statistics.
