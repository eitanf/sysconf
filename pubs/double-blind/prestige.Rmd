...
## Cleaning and inputing the data {#subsec:cleaning}


Figure: grid of density plots of all metrics: npubs; s2npubs; papers in dataset; h-index, h5, i10, total cites, cites/npubs with 'n'
 ...
 * The two tails have the values we're most worried about: ambiguous names; epxnasive vs. mininmal inclusion of publications; inexperienced authors with no GS profile.
...
max, sum, min, mean, seniority tiers, any-famous (plot SD bias as function of threshold)
...
### Ternary classification of seniroty
