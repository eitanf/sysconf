...
Our dataset includes `r nrow(all_confs)` systems conferences, totaling `r sum(all_confs$npapers)` papers and `r nrow(persons)` unique researchers across different conference roles, as detailed in the next section.
