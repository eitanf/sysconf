...
We estimate the rate of women's participation in systems research by using the proxy metric of female author ratio (FAR) in a set of peer-reviewed conferences.
...
The last result is perhaps closest to statistical significance, but it is unlikely to reveal a causal relationship, i.e., that inviting more women to the PC necessarily leads to increased FAR. As we have seen before, there is no correlation between the two, but since conferences generally exhibit higher FPRs than FARs, it makes sense that conferences with higher PC participation in the authorship would also exhibit higher relative FARs.
...
But it is unclear whether this in fact hurts women's retention in the field, since the evaluation of job performance in industry may be less favorable for academic service tasks, so overburdening industry women without proper recognition could be hurting their future representation further.
