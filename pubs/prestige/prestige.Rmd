---
title: Metrics and methods in prestige bias evaluation
author:
...
All analysis was conducted in the statistical software package `R`[@r2021]. For reproducibility, all of the data and source code files we used can be found in the supporting information and at [https://github.com/eitanf/sysconf/](https://github.com/eitanf/sysconf/).
...
Comparing Fig. \@ref(fig:mean-diffs) and Fig. \@ref(fig:median-diffs) shows that many of the metrics and paper aggregations agree in direction (sign) whether looking at the mean values across SB/DB or medians, although confidence levels vary significantly between the two.
...
Double-blind conferences probably attract more of the "impact"-type researchers because these conferences are also correlated with higher reputation metrics, including citations.
