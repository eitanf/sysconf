...
All analysis was conducted in the statistical software package `R`[@rteam13:r]. For reproducibility, all of the data and source code files we used can be found in the supporting information and at [https://github.com/eitanf/sysconf/](https://github.com/eitanf/sysconf/).
...
The informed consent requirement was waived for this secondary analysis.
This study was conducted under Reed College's IRB approval.
