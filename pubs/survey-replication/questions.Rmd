...
survey_with_blind <- survey %>%
  ...
  dplyr::select(c("helpfulness", "understanding", "fairness", "double_blind", "age", "mean_historical_citations", "h5_index", "pc_author_ratio", "mean_authors_per_paper", "acceptance_rate", "pc_paper_ratio", "mean_review_load")) %>%
...
ggplot(survey_with_blind, aes(x=helpfulness, y=Age)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=helpfulness, y=Citations)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=helpfulness, y=h5)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=helpfulness, y=PC_Author)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=helpfulness, y=Authors_Paper)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=helpfulness, y=Acceptance)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=helpfulness, y=PC_Paper)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=helpfulness, y=Review_Load)) + geom_boxplot()

ggplot(survey_with_blind, aes(x=Blind, y=Age)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=Blind, y=Citations)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=Blind, y=h5)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=Blind, y=PC_Author)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=Blind, y=Authors_Paper)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=Blind, y=Acceptance)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=Blind, y=PC_Paper)) + geom_boxplot()
ggplot(survey_with_blind, aes(x=Blind, y=Review_Load)) + geom_boxplot()
...
fit_understanding <- glm(understanding ~ 1 + Age + Citations + h5 + PC_Author + Authors_Paper + Acceptance + PC_Paper + Review_Load + Blind, data=survey_with_blind, family="binomial")
step <- stepAIC(fit, direction="both")
step$anova 
...
The fit above does point towards a high positive significant relationship between double blind conferences and references, however as before the results are inconclusive given the high amount of residual deviance and low R^2 values. 
