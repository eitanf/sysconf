...
Narrative: correlation between technical and presentation should be close to zero: a paper should have technical merit regardless of how well it's written, and vice-versa (caveat: poorly written papers may not transmit their technical merit well, but then again, they'd probably be rejected and therefore not in our dataset).
...
__[MI.13]__ Predicting citations from reviews
...
Ideally, peer review represents an expert unbiased judgement of a paper along multiple indepdent critiera [@peer reivew book?]. The reality is a bit murkier. To assess the independence of reviews, we look next at the correlation of grades among review categories.
