...
\newcounter{rqcounter}  % A macro for a Research Question environment

\newenvironment{question}{%      define a custom environment
   \bigskip\noindent%         create a vertical offset to previous material
   \refstepcounter{rqcounter}% increment the environment's counter
   \textbf{RQ \therqcounter}
   \newline%
   }{\par\bigskip}  %          create a vertical offset to following material
\numberwithin{rqcounter}{section}
